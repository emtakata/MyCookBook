...
#    another_recipe_type = RecipeType.create(name: 'Entrada')
    ...
    another_recipe = Recipe.create(title: 'Salada de cenoura', recipe_type: 'Entrada',
...
#    recipe_type = RecipeType.create(name: 'Sobremesa')
    ...
    recipe = Recipe.create(title: 'Bolo de cenoura', recipe_type: 'Brasileira',
                           cuisine: cuisine, difficulty: 'Médio',
                           cook_time: 60,
                           ingredients: 'Farinha, açucar, cenoura',
                           method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes')
  ...
  scenario 'and got 2 results' do
    ...
    recipe = Recipe.create(title: 'Bolo de cenoura', recipe_type: 'Brasileira',
                           ...
                           ingredients: 'Farinha, açucar, cenoura',
                           method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes')
    another_recipe = Recipe.create(title: 'Bolo de chocolate', recipe_type: 'Brasileira',
                           cuisine: cuisine, difficulty: 'Médio',
                           cook_time: 60,
                           ingredients: 'Farinha, açucar, cenoura',
                           method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes')
  ...
  scenario 'and got no recipe' do
    ...
    visit root_path
    fill_in 'Busca', with: 'Temaki'
    click_on 'Buscar'

    expect(page).to have_css('h1', text: 'Resultado da busca por: Temaki')
    expect(page).to have_css('h2', text: 'Nenhum resultado encontrado')
  end
end
